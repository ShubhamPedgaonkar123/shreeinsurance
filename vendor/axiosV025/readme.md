...
npm version CDNJS Build status Gitpod Ready-to-Code code coverage install size npm downloads gitter chat code helpers Known Vulnerabilities
...
<script src="assets/axiosV025/axios.min.js"></script>
